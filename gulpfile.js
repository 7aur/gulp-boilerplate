...
gulp.task("include", (done) => {
  gulp
    .src([source + "/*.html", source + "/__pages/*.html"])
    .pipe(rigger())
...
gulp.task("sass", function () {
  return gulp
    .src(source + "/__assets/__sass/*.scss")
...
gulp.task("compressCSS", () => {
  return gulp
    .src([source + "/__assets/__sass/__library/*.scss"])
...
gulp.task("compressJS", function (cb) {
  pump(
    [
      gulp.src([source + "/__assets/__script/__library/*.js"]),
      uglify(),
...
gulp.task("fontsmin", function () {
  return gulp
    .src(source + "/__assets/__depencies/__fonts/**/*")
...
gulp.task(
  ...
  gulp.parallel(function () {
    ...
    gulp.watch(
      source + "/__assets/__depencies/__fonts/*",
      gulp.series("fontsmin")
    );
  })
);
